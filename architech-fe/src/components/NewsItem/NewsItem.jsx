    ...
    return (
        <div className='container'>
            <div className='article'>
                ...
                <img className='article-image' src={newsArticle.media || 'https://cdn.pixabay.com/photo/2020/03/05/17/35/tech-news-4905017_640.jpg'} onError={(e) => (e.target.onerror = null, e.target.src = 'https://cdn.pixabay.com/photo/2020/03/05/17/35/tech-news-4905017_640.jpg')} />
